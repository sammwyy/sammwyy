...
```math
\ce{$\unicode[color:red; pointer-events: none; z-index: -1; position: fixed; top: 0; left: 0; height: 100vh; width: 100vw; opacity: 0.20; background: url('https://raw.githubusercontent.com/sammwyy/sammwyy/master/wallpapers/369a329a03ed9e2ed0b7e64cf8913dd2.jpg') no-repeat center center fixed; background-size: cover;]{x0000}$}
```
